...
export class OperationListComponent {
  ...
  public displayedColumns = ['No', 'operationName', 'abbreviation', 'operationCharges', 'Action'];
  ...
  ExportTOExcel()
  {
    ...
    /* save to file */
    XLSX.writeFile(wb, 'Operation-list.xlsx');
...
export class DeleteOperationComponent {
  ...
  constructor( public dialogRef: MatDialogRef<DeleteOperationComponent>, @Inject(MAT_DIALOG_DATA) public data: any, public http: HttpClient, public router: Router, public _com: CommonService){}

  deleteData: any;
  onNoClickDelete(idValue): void{
    this.http.post(this._com.baseUrl+'/deleteOperation', {adminId: localStorage.getItem('adminId'), operationId: idValue}).subscribe(
      result => {
