...
export class DepartmentUpdateComponent implements OnInit {
  ...
  public onSubmit(value):void {
    ...
    if (this.form.valid) {
      this.http.post(this._com.baseUrl+'/updateDepartment', {adminId: localStorage.getItem('adminId'), departmentName: value.departmentName, departmentAbbreviationName: value.departmentAbbreviationName, departmentId: this.paramValue}).subscribe(
        result => {
          this.outPut = result;
