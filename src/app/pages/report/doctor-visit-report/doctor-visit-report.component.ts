...
@Component({
  selector: 'app-doctor-visit-report',
  templateUrl: './doctor-visit-report.component.html',
  styleUrls: ['./doctor-visit-report.component.scss']
})
export class DoctorVisitReportComponent implements OnInit {


  @ViewChild('TABLE') table: ElementRef;
  //@ViewChild(MatPaginator) paginator: MatPaginator;
  public displayedColumns = ['No', 'DoctorName', 'ipdPatinetName', 'charges', 'visitDate'];
  ...
  overAllTotal: any;
	public onSubmit(value):void {
		...
		if (this.form.valid) {
			this.http.post(this._com.baseUrl+'/doctorVisitReport', {adminId: localStorage.getItem('adminId'), doctorId: value.doctorId, fromDate: value.fromDate, toDate: value.toDate}).subscribe(result=> {this.outPut = result;
  ...
  ExportTOExcel()
  {
    ...
    /* save to file */
    XLSX.writeFile(wb, 'doctor-visit-report.xlsx');
