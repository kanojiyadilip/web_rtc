...
@Component({
  selector: 'add-doctor-schedule',
  templateUrl: './add-doctor-schedule.component.html'
})
export class AddDoctorScheduleComponent {
  ...
  public onSubmit(values):void{
    this.http.post(this._com.baseUrl+'/createDoctorSchedule', {adminId: localStorage.getItem('adminId'), doctorId: values.doctorId, department: values.department, day: values.day, fromTime: values.fromTime, toTime: values.toTime}).subscribe(
      result => {
        this.outPut = result;
